...
public class Boton {
    ...
    public static Target RANGO_ANTERIOR = Target.the("Boton para ir al rango anterior").located(By.xpath("//*[contains (@title,'Previous Century')]"));
    public static Target RANGO_SIGUIENTE = Target.the("Boton para ir al siguiente rango").located(By.xpath("//*[contains (@title,'Next Century')]"));
    ...
    public static Target SIGUIENTE = Target.the("Botón Siguiente").located(By.xpath("//*[@id=\"wizard\"]/div[2]/div[1]/a[2]"));
    public static Target FINALIZAR = Target.the("Botón Finalizar").located(By.xpath("//*[@id=\"wizard\"]/div[2]/div[1]/a[3]"));
}
